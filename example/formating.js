...
console.log(`Sri Lanka: ${num2.toLocaleString('si-LK')}}`);
console.log(`Japan: ${num2.toLocaleString('ja-JP')}}`);
console.log(`Bangladesh: ${num2.toLocaleString('bn-BD')}}`);
...
console.log(`\nUS Dollars: ${formatter1.format(monthlySalary)}`);

let formatter2 = new Intl.NumberFormat(`de-DE`, {style:'currency', currency:'EUR'});
console.log(`Euro: ${formatter2.format(monthlySalary)}`);

let formatter3 = new Intl.NumberFormat(`ja-JP`, {style:'currency', currency:'JPY'});
console.log(`Japanese Yen: ${formatter3.format(monthlySalary)}`);